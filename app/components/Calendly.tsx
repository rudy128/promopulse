...
export default function page() {
  return (
    <>
      <div className='bg-white text-4xl lg:text-6xl font-semibold p-6 text-black w-full flex justify-center'><span>Damn, your getting close. <strong className='underline'>Good Job!</strong></span></div>
